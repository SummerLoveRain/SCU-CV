...
% 自定义颜色
\definecolor{primary_color}{RGB}{183,53,49}
\definecolor{secondary_color}{RGB}{200, 68, 28}
...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        % 邮箱
        \faEnvelope \quad \href{mailto:youremail@seu.edu.cn}{yangqh0808@163.com}
        \hspace{4em}
        % 手机号
        \faPhone \quad  138-8024-0944 (微信同号)
        % 别的联系方式，如微信、GitHub等
        % \hspace{4em}
...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north, inner sep=0pt](header) at (current page.north){
            \includegraphics[width=\paperwidth]{images/header_bg.png}
        };
        ...
        \node[anchor=east](school_name) at(header.east){
            \textcolor{primary_color}{\textbf{\school}}
            \hspace{0.5cm}
        };
    \end{tikzpicture}
    \vspace{-3.5em}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.05] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/SCU-Logo.jpg}
        };
    \end{tikzpicture}
    ...
    \begin{minipage}[t]{0.78\textwidth}
        ...
        {\large \textbf{四川大学}}，本科， \hfill 2016年9月--2020年6月
        \begin{itemize}
            \item 计算机学院，计算机科学与技术
        ...
        \vspace{0.5em}
        {\large \textbf{四川大学}}，硕士 \hfill 2020年9月--2023年6月
        \begin{itemize}
            \item 数学学院，你的专业，xxx教授
            \item \textbf{研究方向}：方向1、方向2、方向3、方向4\ 等。
        \end{itemize}
        
        \vspace{0.5em}
        {\large \textbf{四川大学}}，博士 \hfill 2023年9月--2027年6月
        \begin{itemize}
            \item 数学学院，你的专业，xxx教授
            \item \textbf{研究方向}：方向1、方向2、方向3、方向4\ 等。
        \end{itemize}
